...
?>
	<div class="main">		
		...
		<div class="content">
			<div class="node">
			<div class="menu">
	<button name="listofborrowers" class="but">|<a href="reservedlist.php">List of Borrowers</a>|</button>
	<br>
	<br>
<?php
	include("library/connection.php");
	//selecting data from records based on id
	$query = "SELECT * FROM reserve_books where id_number=$_GET[id_number]";
	...
	{	
		...
		$date_tobe_borrow= $rows['date_tobe_borrow'];			
...
<hr width="600">
<table cellspacing="6">
<form class="form" action="updatereserved.php?transaction_id=<?php echo $id_number?>" method="POST">
	...
	<td><input type="date" name="date_tobe_borrow"  value='<?php echo $date_tobe_borrow?>' ></td>required
	<tr>
	<td>Book Title</td>
