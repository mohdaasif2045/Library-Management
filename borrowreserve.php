...
<form class="form" action="reservation.php" method="POST" name="t1">
	<td><label>Scholar number<label></td>
	<td><input type="text" name="scholar_no" value="<?php echo $_GET['scholar_no'];?>" readonly></td>
	<tr>
	<td>Name</td>
	...
	<tr>
	<td>No. Copies</td>
	<td><input type="text" name="no_copies" value="<?php echo $_GET['copies'];?>" readonly></td>
	<tr>
		<td>
