...
<div class="navigation">
	...
	<div class="main">		
		...
		<div class="content">
			<div class="node">
			<div class="menu">
	|<a href="reservedlist.php">List of Reserved Books</a>|
	<br>
	<br>
<hr width="600">
<strong><h1>Reserved Form</h1></strong>
<hr width="600">
<table cellspacing="6">
<form class="form" action="library/reservedformprocess.php" method="POST">
	...
	<tr>
	<td>Book Title</td>
	<td><input type="text" name="book_title" value="<?php echo $_GET['name']; ?>" required></td>
	<tr>
	<td>No. Copies</td>
